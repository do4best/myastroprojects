...
function Topnave(props) {
    ...
    return (
        ...
        <div className="max-w-[1520] mx-auto flex justify-between items-center p-4">
            ...
            <button className={"bg-orange-700 text-white hidden md:flex items-center py-2 px-2 rounded-full "}>
            ...
            <div className={sideNav?"fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-200":"fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-200"}>
                <AiOutlineClose size={25} onClick={()=>setSideNav(!sideNav)} className={"absolute right-4 top-4 cursor-pointer"}/>
                <h2 className="text-2xl p-4 ">Yum<span className={"text-orange-700 font-bold"}>Eats</span></h2>
                <nav>
                    <ul className={"flex flex-col p-4 text-gray-900"}>
                        <li className="text-xl py-4 flex">
                            <BsPerson size={25} className={"text-white mr-4 bg-black rounded-full"}/>
                            My Account
                        </li>
                        <li className="text-xl py-4 flex">
                            <TbTruckReturn size={25} className={"text-white mr-4 bg-black rounded-full"}/>
                            Delivery
                        </li>
                        <li className="text-xl py-4 flex">
                            <MdOutlineFavorite size={25} className={"text-white mr-4 bg-black rounded-full"}/>
                            My Favourite
                        </li>
                        <li className="text-xl py-4 flex">
                            <FaGoogleWallet size={25} className={"text-white mr-4 bg-black rounded-full"}/>
                            My Wallet
                        </li>
                        <li className="text-xl py-4 flex">
                            <MdHelp size={25} className={"text-white mr-4 bg-black rounded-full"}/>
                            Help
                        </li>
                    </ul>
                </nav>
